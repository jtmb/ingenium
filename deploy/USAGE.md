...
**What you get in every project:** the full `.agents/skills/` (46 items total), `AGENTS.md`, `SKILL-INDEX.md`, `docs/` templates, and hooks — all auto-detected to match your framework.
...
├── .agents/
│   ├── skills/                                  ← ALL conventions (46 items)
│   │   ├── generic-conventions/
