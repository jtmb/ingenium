# Skill Learnings Log — This Project

This file logs all skill system changes in **this project**. Appended automatically by `update-skills` and `audit-skills`. Also updated manually after major convention changes.

**For AI models**: After creating, retiring, or significantly updating a skill, append an entry below. After session-end, review what you built — if it introduced a repeated pattern or convention, log it here.

**Format**: Date, brief description, what changed. If this is a skill system repo, include commit hashes.
...
<!-- Project learnings will be appended here by update-skills and audit-skills. AI models: append new entries above this line. -->
