---
name: kubernetes
description: "Kubernetes conventions — security contexts, resource limits, probes, network policies, deployment strategies. Use when writing K8s manifests, Helm charts, or Kustomize overlays."
---
...
Invoke this skill when writing Kubernetes manifests, Helm charts, or Kustomize overlays (`**/{k8s,kubernetes,helm,charts,templates}/**/*.{yaml,yml}`).
