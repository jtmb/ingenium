...
it("catalogues every Phase 3 context and RAG MCP transport contract", () => {
  ...
  for (const name of ["ingenium_context_get", "ingenium_context_update", "ingenium_context_delete", "ingenium_context_batch_get", "ingenium_context_conversation_create", "ingenium_context_conversation_get", "ingenium_context_conversation_list", "ingenium_context_message_append", "ingenium_context_message_list", "ingenium_context_message_search", "ingenium_context_message_retrieve", "ingenium_context_message_batch_retrieve", "ingenium_context_checkpoint_create", "ingenium_context_checkpoint_list", "ingenium_context_checkpoint_get", "ingenium_context_checkpoint_restore", "ingenium_context_opencode_session_import", "ingenium_context_import_current_session", "ingenium_docs_search_semantic", "ingenium_docs_ask", "ingenium_docs_ingest", "ingenium_docs_rag_sources_list", "ingenium_docs_rag_source_get", "ingenium_docs_rag_source_delete", "ingenium_docs_rag_reingest", "ingenium_docs_rag_stats"]) {
