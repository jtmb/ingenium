...
const DOCS_ENDPOINTS = [
  ...
  "GET /api/v1/docs/versions/:versionId",
  ...
  "DELETE /api/v1/docs/attachments/:attachmentId",
  "GET /api/v1/docs/templates",
  "GET /api/v1/docs/templates/:id",
  "POST /api/v1/docs/templates",
  "DELETE /api/v1/docs/templates/:id",
  "POST /api/v1/docs/pages/:pageId/link-project",
  "DELETE /api/v1/docs/pages/:pageId/link-project",
  ...
  "GET /api/v1/docs/export/:spaceId",
