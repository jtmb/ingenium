 ...
 */
export function extractTemplate(skillContent) {
 ...
 */
function calculateConfidence(skill, email) {
    let confidence = 0;
 ...
 */
export async function suggestResponse(projectId, accountId, uid, folder) {
