...
declare -a FILES=(
    ...
    ".agents/skills/github-actions-hardening/SKILL.md|.agents/skills/github-actions-hardening/SKILL.md|always"
    ".agents/skills/github-actions-efficiency/SKILL.md|.agents/skills/github-actions-efficiency/SKILL.md|always"
    ".agents/skills/postgresql-optimization/SKILL.md|.agents/skills/postgresql-optimization/SKILL.md|always"
    ".agents/instructions/debugging-patterns/SKILL.md|.agents/instructions/debugging-patterns/SKILL.md|always"
    ...
    ".agents/instructions/self-correction-patterns/SKILL.md|.agents/instructions/self-correction-patterns/SKILL.md|always"
    ...
    ".agents/instructions/local-model-commands/SKILL.md|.agents/instructions/local-model-commands/SKILL.md|always"
    ".agents/instructions/skill-load/SKILL.md|.agents/instructions/skill-load/SKILL.md|always"
    ...
    ".agents/instructions/repo-context/SKILL.md|.agents/instructions/repo-context/SKILL.md|optional"
    ".agents/instructions/generate-docs/SKILL.md|.agents/instructions/generate-docs/SKILL.md|optional"
    ".agents/instructions/write-docs/SKILL.md|.agents/instructions/write-docs/SKILL.md|optional"
    ".agents/instructions/update-skills/SKILL.md|.agents/instructions/update-skills/SKILL.md|always"
    ".agents/instructions/update-skill-index/SKILL.md|.agents/instructions/update-skill-index/SKILL.md|always"
    ".agents/instructions/audit-skills/SKILL.md|.agents/instructions/audit-skills/SKILL.md|always"
    ".agents/instructions/help/SKILL.md|.agents/instructions/help/SKILL.md|optional"
    ".agents/tools/web-design-reviewer/SKILL.md|.agents/tools/web-design-reviewer/SKILL.md|optional"
    ".agents/tools/chrome-devtools/SKILL.md|.agents/tools/chrome-devtools/SKILL.md|optional"
    ".agents/tools/playwright-mcp/SKILL.md|.agents/tools/playwright-mcp/SKILL.md|optional"
    ".agents/tools/gh-cli/SKILL.md|.agents/tools/gh-cli/SKILL.md|optional"
    ".agents/tools/github-issues/SKILL.md|.agents/tools/github-issues/SKILL.md|optional"
...
gitignore_entries=(
    ...
    ".agents/instructions/*/SKILL.md.bak"
    ".agents/tools/*/SKILL.md.bak"
)
