...
declare -a FILES=(
    ...
    ".agents/skills/manage-agents/SKILL.md|.agents/skills/manage-agents/SKILL.md|optional"
    ".github/agents/plan.agent.md|.github/agents/plan.agent.md|optional"
    ".github/agents/explore.agent.md|.github/agents/explore.agent.md|optional"
    ".github/agents/coder.agent.md|.github/agents/coder.agent.md|optional"
    ".github/agents/doc-writer.agent.md|.github/agents/doc-writer.agent.md|optional"
