...
declare -a FILES=(
    ...
    ".agents/agents/plan.agent.md|.agents/agents/plan.agent.md|optional"
    ".agents/agents/explore.agent.md|.agents/agents/explore.agent.md|optional"
    ".agents/agents/coder.agent.md|.agents/agents/coder.agent.md|optional"
    ".agents/agents/doc-writer.agent.md|.agents/agents/doc-writer.agent.md|optional"
