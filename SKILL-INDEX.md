...
**Total: 46 skills** (all in `.agents/skills/`)
...
| [kaban-board](.agents/skills/kaban-board/SKILL.md) | Kaban task board operations | Kaban — terminal Kanban board for AI agents. MCP server, CLI, and TUI for task management. |
