...
- Pay attention to provided agent instructions, rules, and skills as they apply to areas of the codebase to better understand architecture and best practices.
- Use available search tools to find references in external dependencies.
