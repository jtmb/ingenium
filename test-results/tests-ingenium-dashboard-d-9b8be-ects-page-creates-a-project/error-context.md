...
- Name: tests/ingenium-dashboard/dashboard.spec.ts >> Ingenium Dashboard >> projects page creates a project
- Location: tests/ingenium-dashboard/dashboard.spec.ts:48:7
...
Call log:
  - navigating to "/projects", waiting until "load"
