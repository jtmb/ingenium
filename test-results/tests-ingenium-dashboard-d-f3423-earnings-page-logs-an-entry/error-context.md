...
- Name: tests/ingenium-dashboard/dashboard.spec.ts >> Ingenium Dashboard >> learnings page logs an entry
- Location: tests/ingenium-dashboard/dashboard.spec.ts:87:7
...
Call log:
  - navigating to "/learnings", waiting until "load"
