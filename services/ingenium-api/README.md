...
- JSON body limit: 2 MiB for ordinary requests; the exact authenticated
  `POST /api/v1/repository/sync` ingress has a separate 4 MiB bound for the
  combined repository manifest.
