...
server.registerTool("ingenium_skill_delete", { description: "Delete a skill by name.", inputSchema: { project: projectParam, name: z.string() } }, wrapHandler("ingenium_skill_delete", async ({ project, name }) => skillTools.skillDelete(project, name)));
...
}, wrapHandler("ingenium_observe", async ({ project, observation_type, content, importance, source, context }) => observationStore(project, observation_type, content, importance, source, context)));
...
server.registerTool("ingenium_plan_list", { description: "List plan/context entries.", inputSchema: { project: projectParam } }, wrapHandler("ingenium_plan_list", async ({ project }) => planList(project)));
// ── Projects ────────────────────────────────────────────
...
server.registerTool("ingenium_project_restore", { description: "Restore an archived project.", inputSchema: { project: projectParam, name: z.string() } }, wrapHandler("ingenium_project_restore", async ({ project, name }) => projectRestore(project, name)));
server.registerTool("ingenium_project_list_archived", { description: "List archived projects.", inputSchema: { project: projectParam } }, wrapHandler("ingenium_project_list_archived", async ({ project }) => projectListArchived(project)));
server.registerTool("ingenium_project_purge", { description: "Purge old projects.", inputSchema: { project: projectParam, retentionDays: z.number().optional() } }, wrapHandler("ingenium_project_purge", async ({ project, retentionDays }) => projectPurge(project, retentionDays)));
server.registerTool("ingenium_project_set_global", { description: "Mark a project as global (or unmark).", inputSchema: { project: projectParam, name: z.string(), isGlobal: z.boolean() } }, wrapHandler("ingenium_project_set_global", async ({ project, name, isGlobal }) => projectSetGlobal(project, name, isGlobal)));
// ── Plugins ─────────────────────────────────────────────
...
server.registerTool("ingenium_plugin_get", { description: "Get a single plugin by name.", inputSchema: { project: projectParam, name: z.string() } }, wrapHandler("ingenium_plugin_get", async ({ project, name }) => pluginGet(project, name)));
...
server.registerTool("ingenium_command_get", { description: "Get a command by name.", inputSchema: { project: projectParam, name: z.string() } }, wrapHandler("ingenium_command_get", async ({ project, name }) => commandGet(project, name)));
