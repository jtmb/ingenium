...
function normalizedApiToken(value) {
    ...
    if (!token || token.length > MAX_TOKEN_LENGTH || !/^[\x21-\x7e]+$/.test(token))
        return undefined;
    return token;
}
 ...
 */
function readTokenFile(reference) {
...
function resolveApiToken() {
    ...
    if (placeholder !== undefined)
        return readTokenFile(placeholder);
