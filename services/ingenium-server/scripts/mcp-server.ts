...
server.registerTool(
  ...
  async ({ project, name, description, content, category, tags, always_apply, files }) =>
...
server.registerTool(
  ...
  async ({ project, title, description, assigned_to }) =>
...
server.registerTool(
  ...
  async ({ project, task_id }) => taskTools.taskComplete(project, task_id),
);
...
server.registerTool(
  ...
  async ({ project, name }) => pluginTools.pluginEnable(project, name),
);
...
server.registerTool(
  ...
  async ({ project }) => serverTools.serverList(project),
);
