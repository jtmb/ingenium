...
/**
 * Metadata for a child MCP server process managed by this parent.
 * Servers are identified by name (unique key in the managedServers map).
 */
interface ManagedServer {
  ...
  /** The child process handle — null when not running or after exit/error. */
