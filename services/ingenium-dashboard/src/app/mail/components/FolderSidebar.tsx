...
import { Dropdown, DropdownItem, DropdownPanel, DropdownSeparator, DropdownTrigger } from '../../components/Dropdown';
  ...
  return (
    <div className="min-w-[200px] max-w-[250px] flex-shrink-0 bg-[var(--color-surface-muted)] border-r border-[var(--color-border)] p-2 flex flex-col gap-2">
      ...
      <Dropdown open={isOpen} onOpenChange={setIsOpen}>
        <DropdownTrigger
          aria-label={selectedAccountData ? `Select account, current ${selectedAccountData.email}` : "Select account"}
        ...
        {isOpen && (
          <DropdownPanel aria-label="Email accounts" className="left-0 right-0 top-full mt-1 max-h-[60vh] overflow-y-auto p-0">
            ...
            {visibleAccounts.map((acct: any) => (
              <div key={acct.id} className="flex items-center">
                <DropdownItem
                  ...
                  selected={selectedAccount === acct.id || selectedAccount === acct.email}
                ...
                {onHideAccount && (
                  <DropdownItem
                    ...
                    closeOnSelect={false}
                    aria-label={`Hide ${acct.email}`}
                    className="w-auto rounded-none px-2 py-2 text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)]"
                ...
                {onDeleteAccount && (
                  <DropdownItem
                    ...
                    className="w-auto rounded-none px-2 py-2 text-red-500 hover:bg-[var(--color-error-bg)] hover:text-[var(--color-error-text)]"
            ...
            {hiddenAccounts.length > 0 && (
              <>
                ...
                <DropdownItem
                  ...
                  className="rounded-none px-3 py-2 text-[var(--color-text-muted)]"
                >
                  <svg
                  ...
                  <div key={acct.id} className="flex items-center pl-4">
                    ...
                    {onShowAccount && (
                      <DropdownItem
                        ...
                        closeOnSelect={false}
                        aria-label={`Show ${acct.email}`}
                        className="w-auto rounded-none px-2 py-2 text-[var(--color-text-link)] hover:text-[var(--color-text-link-hover)]"
            ...
            {onAddAccount && (
              <>
                ...
                <DropdownItem
                  ...
                  className="rounded-none px-3 py-2 text-[var(--color-text-link)]"
                >
                  + Add Account
                </DropdownItem>
              </>
