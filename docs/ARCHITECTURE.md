...
│   ├── skills/                 ← 26 skills — each is a SKILL.md with YAML frontmatter
...
- `deploy/.agents/skills/` — All 22 deployable skills (excludes 4 source-only: create-readme, gh-cli, playwright-mcp, thread-auto-context)
