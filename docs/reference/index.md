...
description: Technical reference documents for the Ingenium system — environment variables, MCP tools, skill taxonomy, and docs workspace.
---
...
| [MCP Tools Reference](./mcp-tools.md) | Built-in 268-tool catalog across 28 baseline categories (266 server + 2 extension) plus dynamic child tools |
