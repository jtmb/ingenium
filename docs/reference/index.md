...
| [MCP Tools Reference](./mcp-tools.md) | Built-in 292-tool catalog across 32 baseline categories (290 `ingenium_` entries + 2 extension tools) plus dynamic child tools |
