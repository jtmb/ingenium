...
- **One concern per skill.** Each `.agents/skills/{name}/`, `.agents/instructions/{name}/`, or `.agents/tools/{name}/` contains exactly one `SKILL.md`. No bundling — testing rules and styling rules go in separate skills.
