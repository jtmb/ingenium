...
- **MCP**: @modelcontextprotocol/sdk for stdio transport (269 built-in catalog tools across 28 baseline categories; 266 registered by the server and 3 by the extension, with project-scoped child tools added dynamically)
